...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CntOPzv3.mjs");
...
var manifest = {
	"af211be017b1f11806ab14644bd9fb219a3adb1d3414d2bf890a471ecad5d6d9": {
		functionName: "askSwiftAi_createServerFn_handler",
		importer: () => import("./ai.functions-BQuKER56.mjs")
	},
	"d32096360d2395db7635cc2ade8834c7880bd89519d876f34f55cdb81a44b04f": {
		functionName: "askComplianceKnowledge_createServerFn_handler",
		importer: () => import("./compliance-knowledge.functions-BLlit_aC.mjs")
	}
};
